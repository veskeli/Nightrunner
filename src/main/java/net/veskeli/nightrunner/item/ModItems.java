...
public class ModItems {
    ...
    // Wands
    public static final DeferredItem<Item> WoodenWand = ITEMS.register("wooden_wand", () -> new WandItem(new Item.Properties().durability(59)));
    public static final DeferredItem<Item> StoneWand = ITEMS.register("stone_wand", () -> new WandItem(new Item.Properties().durability(131)));
    public static final DeferredItem<Item> GoldWand = ITEMS.register("gold_wand", () -> new WandItem(new Item.Properties().durability(32)));
    public static final DeferredItem<Item> IronWand = ITEMS.register("iron_wand", () -> new WandItem(new Item.Properties().durability(250)));
    public static final DeferredItem<Item> DiamondWand = ITEMS.register("diamond_wand", () -> new WandItem(new Item.Properties().durability(1561)));
